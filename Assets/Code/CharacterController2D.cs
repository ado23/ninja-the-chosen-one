...
public class CharacterController2D : MonoBehaviour 
{
	...
	private const int TotalHorizontalyRays = 8;
	...
	public void Awake()
	{
		...
		_verticalDistanceBetweenRays = colliderHeight / (TotalHorizontalyRays - 1);
	...
	private void Move(Vector2 deltaMovement)
	{
		...
		if (HandleCollisions) 
		{
			...
			if (deltaMovement.y < 0 && wasGrounded) 
				HandleVerticallSlope (ref deltaMovement);
	...
	private void CorrectHorizontalPlacement(ref Vector2 deltaMovement, bool isRight)
	{
		...
		for(var i = 1; i < TotalHorizontalyRays - 1; i++)
		{
	...
	private void MoveHorizontaly(ref Vector2 deltaMovement)
	{
		...
		for (var i = 0; i < TotalHorizontalyRays; i++) 
		{
	...
	private void HandleVerticallSlope(ref Vector2 deltaMovement)
	{
